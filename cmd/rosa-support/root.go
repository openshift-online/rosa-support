...
var rootCmd = &cobra.Command{
	Use:           "rosa-support",
	Short:         "Command line tool for ROSA support",
	Long:          `Command line tool for ROSA development and support`,
	SilenceErrors: true,
...
func init() {
	...
	// rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.rosa-support.yaml)")
